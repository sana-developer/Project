  ...
  return (
    ...
    <div className='flex'> 
      <div className='img-part'>
        <img src="src/assets/aboutImage.png" alt="Photo" />
      </div>
      
      <div className='pr-14 pl-9 mt-6 ml-4 ml-2 text-part'>
        <div className='bold mt-20'><span className='border-aqua pb-2'>About Me</span></div>
