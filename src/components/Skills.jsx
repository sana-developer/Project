...
function Skills() {
  return (
    <div className='skills'>
        <div className='bold my-5 mb-12 text-center'><span className='border-aqua pb-2'>Skills That I have</span></div>
    <div className='flex justify-center mx-auto m-new'>
      <div className='m-icons'>
        <i className="fa-5x fa-brands fa-html5" 
        style={{color: '#df1616'}}></i>
        <h3 className='text-center'>HTML</h3>
      </div>
      <div className='m-icons'>
        <i className="fa-5x fa-brands fa-css3-alt" 
        style={{color: '#0047c2'}}></i>
        <h3 className='text-center'>CSS</h3>
      </div>
      <div className='m-icons'>
        <i className="fa-5x fa-brands fa-js" 
        style={{color: '#ebcc05'}}></i>
        <h3 className='text-center'>Javascript</h3>
      </div>
      <div className='m-icons'>
        <i className="fa-5x fa-brands fa-node" 
        style={{color: '#0f5832'}}></i>
        <h3 className='text-center'>Node JS</h3>
      </div>
      <div className='m-icons'>
        <i className="fa-5x fa-brands fa-react" 
        style={{color: '#018ca7'}}></i>
